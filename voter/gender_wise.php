...
$sql1 = "SELECT count(Gender) From voter_master INNER JOIN voting on voter_master.Id=voting.V_id where Gender='Male'";
	...
	$sql2 = "SELECT count(Gender) From voter_master INNER JOIN voting on voter_master.Id=voting.V_id where Gender='Female'";
...
<html>
<head>
<title>Result | Gender wise</title>
...
function drawChart() 
{
 ...
 var options = {
  title: "Total Voted Male and Female."
 };
